...
export const GALLERY_ITEMS = [
  { src: '/images/lumen-01.png', width: 1536, height: 1024, alt: 'Round savoury pastry with pesto swirl, poppy seeds, and parmesan on natural parchment', caption: 'Pesto crown' },
  { src: '/images/lumen-02.png', width: 1536, height: 1024, alt: 'Round pastry topped with cured charcuterie and finely grated cheese on natural parchment', caption: 'Cheese & charcuterie' },
  { src: '/images/lumen-03.png', width: 990, height: 659, alt: "Stack of gourmet s'mores with berry and chocolate ripples in marshmallow", caption: "Stacked s'mores" },
  { src: '/images/lumen-04.png', width: 1536, height: 1024, alt: 'Raspberry mille-feuille with pistachio quenelle on a white plate over marble', caption: 'Mille-feuille' },
  { src: '/images/lumen-05.png', width: 1536, height: 1024, alt: 'Chef\'s savoury plate with sliced protein, roasted vegetables, and jus on a dark blue plate', caption: "Chef's savoury" },
  { src: '/images/lumen-06.png', width: 1024, height: 819, alt: 'Overhead view of a fine-dining plate with protein and garnish', caption: 'Midnight plate' },
  { src: '/images/lumen-07.png', width: 1536, height: 1024, alt: 'Purple and maple-glazed cruller duo on parchment', caption: 'Cruller duo' },
  { src: '/images/lumen-08.png', width: 1000, height: 666, alt: 'Pumpkin pie with whipped cream and one slice removed', caption: 'Pumpkin custard' },
  { src: '/images/lumen-09.png', width: 1536, height: 1024, alt: 'Nordic coconut bun with custard filling on a teal plate', caption: 'Nordic bun' },
  { src: '/images/lumen-10.png', width: 540, height: 810, alt: 'Stack of chocolate biscuit bars with white drizzle', caption: 'Chocolate slab' },
  { src: '/images/lumen-11.png', width: 1024, height: 1024, alt: 'Close-up of pale cream dollops with candied fruit and herbs', caption: 'Lemon silk' },
  { src: '/images/lumen-13.png', width: 1024, height: 522, alt: 'Round tart topped with dried fruit, nuts, and rosemary', caption: 'Winter tart' },
  { src: '/images/lumen-14.png', width: 1024, height: 681, alt: 'Fudgy brownies on a cooling rack with baking tin behind', caption: 'Brownie rack' },
];
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: '£5',
        image: '/images/menu/menu-sourdough.png',
        alt: 'Thick slice of sourdough toast with butter',
      },
      {
        name: 'Winter herb tart slice',
        price: '£8',
        image: '/images/menu/menu-winter-tart.png',
